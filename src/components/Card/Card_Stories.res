...
let default = Storybook.make(
  ...
  ~component=Card.CardWrapperStorybook.make,
  ~argTypes={
    ...
    description: Storybook.argType(
      ~defaultValue=Card.CardWrapperStorybook.mockDescription,
      ~control=Text,
      (),
    ),
    imgUrl: Storybook.argType(~defaultValue=Card.CardWrapperStorybook.mockImgUrl, ~control=Text, ()),
